...
-Nav Tags:[SwitchTab:tab_id],[SwitchSubTab:subtab_id].Tabs:chat,agent,image,advaiconv,arena,aiconv,files,tools,packages,memory,logs,usage,status,settings,finance,tracking,linkmap,code,schedule. Settings subtabs:assistant,system,env,providers,profiles,notifications.
