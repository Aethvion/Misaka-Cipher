...
- [ ] Tested in Web mode (`python main.py`)
- [ ] Ran test suite (`python main.py --test`)
- [ ] Tested with multiple providers (Google AI, OpenAI, Grok)
- [ ] Tested tool generation (if applicable)
...
- [ ] The Memory Tier (storage/retrieval)
...
- [ ] New code passes Intelligence Firewall validation
